    ...
    <div>
      <div className="border-b border-line-subtle bg-sunken/40">
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
          <Eyebrow className="mb-3">Directory · {allTools.length} tools</Eyebrow>
          <h1 className="text-hero font-semibold text-fg">Every tool, both layers.</h1>
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div role="radiogroup" aria-label="Layer filter" className="flex rounded-lg border border-line-subtle bg-sunken p-0.5">
                {layerTabs.map((tab) => {
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-lg border border-line-subtle bg-surface px-3 py-2 text-xs text-muted lg:hidden"
                ...
                <div className="relative inline-flex items-center">
                  ...
                  <select
                    ...
                    className="appearance-none rounded-lg border border-line-subtle bg-surface py-2 pl-8 pr-8 text-xs text-muted outline-none transition-colors hover:border-line-strong focus-visible:border-accent/60"
                  >
                    {sorts.map((s) => (
            ...
            <div className="hidden gap-1.5 overflow-x-auto pb-1 lg:flex">
              <button
                type="button"
                ...
                className={cn(
                  ...
                  !category
                    ...
                    : "border-line-subtle bg-surface text-faint hover:border-line-strong hover:text-muted"
                )}
              >
                All
              </button>
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        {results.length > 0 ? (
          <AnimatePresence mode="popLayout" initial={false}>
            <ul key={`${type}-${category}-${sort}`} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {results.map((tool, i) => (
          ...
          <div className="flex flex-col items-center gap-4 rounded-xl border border-line-subtle bg-surface px-6 py-20 text-center">
            ...
            <button type="button" onClick={resetAll} className="rounded-lg border border-line-strong px-4 py-2 text-xs font-medium text-fg hover:border-accent/50">
              Reset all filters
            </button>
          </div>
        )}
