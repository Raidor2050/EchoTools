    ...
    <footer className="border-t border-line-subtle bg-sunken/60">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6">
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          ...
          <div>
            <p className="eyebrow mb-4">Trust & disclosure</p>
            ...
            <div className="mt-4 flex gap-4">
              <Link href="/disclosure" className="text-xs text-muted underline-offset-4 hover:text-fg hover:underline">
                Affiliate disclosure
              </Link>
              <Link href="/llms.txt" className="text-xs text-muted underline-offset-4 hover:text-fg hover:underline">
                llms.txt
              </Link>
            </div>
          </div>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-line-subtle pt-6 text-xs text-faint sm:flex-row sm:items-center sm:justify-between">
